...
T = { comentarioFinDeLinea ->  c == '\\n' \n putchar(' '), putchar(c)->comienzoDeLinea, comentarioFinDeLinea -> EOC ->comentarioFinDeLinea,comentarioMultilinea ->  c == '*' 
     ->posibleFinDeComentarioMultilinea, comentarioMultilinea -> EOC ->comentarioMultilinea,posibleFinDeComentarioMultilinea ->  c == '*' -> posibleFinDeComentarioMultilinea,           posibleFinDeComentarioMultilinea -> c == '/' \n putchar(' ') ->  FinDeComentarioMultilinea, posibleFinDeComentarioMultilinea -> EOC ->comentarioMultilinea, 
    ...
    *comienzoDeLinea -> ->caracterEspecial [label = " EOC \n putchar(c)"];
    ...
    d -> ->enPalabra [label = "c =='' or 'A'...'Z' or 'a'...'d' or 'f'...'z'  \n printf(#d), nuevaPalabra(c)" ];
    ...
    de -> ->enPalabra [label = "c =='' or  'A'...'Z' or  'a'...'e' or  'g'...'z' \n printf(#de), nuevaPalabra(c)" ];
    ...
    def -> ->enPalabra [label = "c =='' or  'A'...'Z' or  'a'...'h' or  'j'...'z' \n printf(#def), nuevaPalabra(c)" ];
    ...
    defi -> ->enPalabra [label = "c =='' or  'A'...'Z' or  'a'...'m' or  'o'...'z' \n printf(#defi), nuevaPalabra(c)" ];
    ...
    defin -> ->enPalabra [label = "c =='' or  'A'...'Z' or 'a'...'d' or  'f'...'z' \n printf(#defin), nuevaPalabra(c)" ];
    ...
    define -> ->enPalabra [label = "c =='' or  'A'...'Z' or  'a'...'d' or  'f'...'z' \n printf(#define), nuevaPalabra(c)" ];
    ...
    defineIdentificador -> ->defineIdentificador [label = "c =='_' or 'A'...'Z' or 'a'...'z' or '0'...'9' \n nuevoIdentificador(c)" ];
    ...
    u -> ->enPalabra [label = "c =='_' or 'A'...'Z' or 'a'...'m' or 'o'...'z' \n printf(#u), nuevaPalabra(c)" ];
    u -> ->caracterEspecial [label = "c == 'EOC' \n printf(#u), putchar(c)" ];
    ...
    un -> ->enPalabra [label = "c =='_' or 'A'...'Z' or 'a'...'c' or 'e'...'z' \n printf(#un), nuevaPalabra(c)" ];
    un -> ->caracterEspecial [label = "c == 'EOC' \n printf(#un), putchar(c)" ];
    ...
    und -> ->enPalabra [label = "c =='_' or 'A'...'Z' or 'a'...'d' or 'f'...'z' \n printf(#und), nuevaPalabra(c)" ];
    und -> ->caracterEspecial [label = "c == 'EOC' \n printf(#und), putchar(c)" ];
    ...
    unde -> ->enPalabra [label = "c =='_' or 'A'...'Z' or 'a'...'e' or 'g'...'z' \n printf(#unde), nuevaPalabra(c)" ];
    unde -> ->caracterEspecial [label = "c == 'EOC' \n printf(#unde), putchar(c)" ];
    ...
    esUndef -> ->enPalabra [label = "c =='_' or 'A'...'Z' or 'a'...'z' \n printf(#undef), nuevaPalabra(c)" ];
    esUndef -> ->caracterEspecial [label = "c == 'EOC'  \n printf(#undef), putchar(c)" ];

    undefEspacio -> ->undefIdentificador [label = "c =='_' or 'A'...'Z' or 'a'...'z' \n nuevoIdentificador(c)" ];
    undefEspacio -> ->undefEspacio [label = "c == ' ' or c == '\\t' " ];
    undefEspacio -> ->identificadorInvalido [label = "c == 'EOC' " ];

    undefIdentificador -> ->undefIdentificador [label = "c =='_' or 'A'...'Z' or 'a'...'z' or '0'...'9' \n nuevoCaracterIdentificador(c)" ];
